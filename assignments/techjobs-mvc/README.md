...
- This is a big one. First, a warning:
    ...
    1. Write a static method `getActionChoices` in `TechJobsController` that returns the `actions` hash map. Add the annotation `@ModelAttribute("actions")` to this method.
